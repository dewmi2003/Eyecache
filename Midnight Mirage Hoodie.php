<?php
// Product Data (id=8 for Midnight Mirage)
$product = [
    "id" => 8,
...
<div class="container">
  <div class="left">
    <img src="assets/MARISA OVERSIZED HOODIE - Medium _ Black.jpeg" alt="<?php echo $product['name']; ?>">
  </div>
  <div class="right">
...
<script>
  document.getElementById("addToCartBtn").addEventListener("click", () => {
    ...
    let user_id = "nfn99a4i0btdo7kbsd5avllfmp"; // replace with actual user id
