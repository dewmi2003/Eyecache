<?php
// Product Data (use id=7 from your products table)
$product = [
    "id" => 7,
    "name" => "Citrine Glow",
...
<head>
   ...
   * { box-sizing: border-box; margin: 0; padding: 0; }
   ...
   footer {
      background-color: #111; color: #bbb; text-align: center;
      padding: 1.5rem 0; font-size: 1rem; margin-top: auto; border-top: 1px solid #222;
    }
  </style>
</head>
<body>
...
<script>
  ...
  qtyInput.addEventListener("input", () => {
    ...
    priceElement.innerText = currency + " " + finalPrice.toLocaleString();
  });
