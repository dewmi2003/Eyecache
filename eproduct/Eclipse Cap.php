<?php
$product = [
    "id" => 3, // add an ID if you want for cart integration
    "name" => "Eclipse Cap",
    "category" => "Unisex / Casual Wear / Style",
    "Code" => "10022634",
    "price" => 2500,
    "currency" => "LKR.",
    "colors" => [
...
document.getElementById("addToCartBtn").addEventListener("click", () => {
    ...
    let size = null; // no size for caps
    let user_id = "nfn99a4i0btdo7kbsd5avllfmp"; // example user ID
